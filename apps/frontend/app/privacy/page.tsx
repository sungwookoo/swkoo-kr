...
export default function PrivacyPage(): import("react").ReactNode {
  return (
    <main className="relative isolate w-full px-6 py-20 sm:py-24">
      <div className="mx-auto w-full max-w-3xl space-y-8">
        ...
        <Section title="선택 기능: npm 의존성 취약점 수정 PR (2026-09-24 갱신)">
          <p>사용자가 별도로 요청한 경우에만 저장소 식별자·기준 commit과 package.json·package-lock.json을 읽어 보안 수정안을 준비합니다. 의존성 이름·버전은 npm 공개 레지스트리에 전송됩니다.</p>
          <p>수정 전후 취약점의 식별자·심각도·근거 링크·검사된 버전과 검사 시각을 수정안에 함께 보관하며, 초안 PR 생성 시 해당 근거를 PR 본문에 포함합니다.</p>
