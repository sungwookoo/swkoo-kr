...
export function DeployPageClient(): import("react").ReactNode {
...
function AccountSection({ login }: { login: string }): import("react").ReactNode {
  const router = useRouter();
  const { mutate } = useSWRConfig();
...
function CurrentBanner(): import("react").ReactNode {
...
function PreviewPanel({ fullName }: { fullName: string }): import("react").ReactNode {
...
function LanguagePill({ language }: { language: string }): import("react").ReactNode {
