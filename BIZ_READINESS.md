...
2026-09-15 콘솔 확인: Pay As You Go 계정, A1 4 OCPU/24GB 운영, 당월 표시 비용 SGD 0.00. Always Free 전용 계정 한도를 그대로 적용하지 않는다. 단일 노드 장애 시 모든 앱이 중단되므로 SLA를 보장하지 않는다. 실효 가용성 수치는 측정 후 산정한다.
